...
unsigned long activetyTimeDelay = 15000; // The time activety is held befor it counts it as not completed (1.8 mill = half an hour) but set to 15000 for testing purposes
const int buttonPin = 2;              // Pin where the button is connected
int buttonState = 0;                  // Variable for reading the buttonstate
int ledPin = 3;                       //Pin where led indicator is connected
